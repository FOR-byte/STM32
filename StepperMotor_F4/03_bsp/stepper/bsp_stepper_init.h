...
//Motor 脉冲
#define MOTOR_PUL_IRQn                  TIM5_IRQn
#define MOTOR_PUL_IRQHandler            TIM5_IRQHandler

#define MOTOR_PUL_TIM                   TIM5
#define MOTOR_PUL_CLK_ENABLE()  		__TIM5_CLK_ENABLE()
...
#define MOTOR_PUL_GPIO_AF               GPIO_AF2_TIM5
